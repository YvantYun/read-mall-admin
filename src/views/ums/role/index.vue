  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="roleTable"
        ...
        <el-table-column label="分配" width="160" align="center">
          <template slot-scope="scope">
            <el-row>
              <el-button size="mini"
                         type="text"
  ...
  export default {
    ...
    methods: {
      ...
      handleSelectMenu(index,row){
        this.$router.push({path:'/admin/allocMenu',query:{roleId:row.id}})
      },
      handleSelectResource(index,row){
        this.$router.push({path:'/admin/allocResource',query:{roleId:row.id}})
      },
      getList() {
