...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleAddMenu() {
        this.$router.push('/admin/addMenu');
      },
      getList() {
      ...
      handleShowNextLevel(index, row) {
        this.$router.push({path: '/admin/menu', query: {parentId: row.id}})
      },
      handleParentMenu() {
        this.$router.push({path: '/admin/menu', query: {parentId: 0}})
      },
      handleUpdate(index, row) {
        this.$router.push({path:'/admin/updateMenu',query:{id:row.id}});
      },
